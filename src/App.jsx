                ...
                <div className="table-wrap" style={{ marginBottom: 20 }}>
                  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13, tableLayout: "fixed" }}>
                    ...
                    <thead><tr>
                      ...
                      <th style={{ ...headerStyle, textAlign: "right" }}>FACTORY (CAD)</th>
                      <th style={{ ...headerStyle, textAlign: "right" }}>{`MIN SELL (${activePL.currency})`}</th>
                      <th style={{ ...headerStyle, textAlign: "right" }}>{`SELL (${activePL.currency})`}</th>
                    ...
                    <tbody>
                      {byCategory[cat].map(item => (
                        <tr key={item.key} className="row-hover" style={{ borderBottom: `1px solid ${THEME.border}` }}>
                          <td style={{ ...colStyle, textAlign: "left", fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {item.name}
